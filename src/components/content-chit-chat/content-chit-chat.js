...
class ContentChitChat extends Component {
  ...
  changeVolume(e) {
    if (this.state.playing == true) {
      ...
      document
        .getElementsByClassName("content-chit-chat__pause-svg ")[0]
        .classList.add("invisible")
      document
        .getElementsByClassName("content-chit-chat__pause-svg ")[0]
        .classList.remove("visible")
      document
        .getElementsByClassName("content-chit-chat__play-svg ")[0]
    ...
    return (
      <div>
        ...
        <svg
          ...
          viewBox="0 0 24 24"
          width="60"
          className="content-chit-chat__pause-svg content-chit-chat-control invisible"
          onClick={e => this.changeVolume(e)}
        >
          <path d="M0 0h24v24H0z" fill="none" />
        ...
        <svg
          ...
          viewBox="0 0 24 24"
          width="60"
          className="content-chit-chat__play-svg content-chit-chat-control"
          onClick={e => this.changeVolume(e)}
        >
          <path d="M0 0h24v24H0z" fill="none" />
